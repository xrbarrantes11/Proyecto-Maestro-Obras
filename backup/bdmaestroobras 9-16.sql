...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2022 a las 20:44:31
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insertar_planilla` (`tbplanillaid` INT, `tbplanilladeducciones` INT, `tbplanillahorastrabajadas` INT, `tbplanillafecha` DATE, `tbplanillahorasextra` INT, `tbempleadoid` INT, `tbplanillatotal` INT)   Insert into tbplanilla (tbplanillaid, tbplanilladeducciones, tbplanillahorastrabajadas, tbplanillafecha, tbplanillahorasextra, tbempleadoid, tbplanillatotal)
Values (tbplanillaid, tbplanilladeducciones, tbplanillahorastrabajadas, tbplanillafecha, tbplanillahorasextra, tbempleadoid, tbplanillatotal)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ver_planilla` ()   Select * from tbplanilla$$
