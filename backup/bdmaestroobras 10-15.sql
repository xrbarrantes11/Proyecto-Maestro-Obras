...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2022 a las 06:25:41
...
INSERT INTO `tbcotizacion` (`tbcotizacionid`, `tbobraid`, `tbproveedorid`) VALUES
(1, 3, 2);
...
(1, 'Dia', 'Contrato', 'Pago', 1),
(2, 'Hora', 'Contrato', 'Pago por hora', 1);
