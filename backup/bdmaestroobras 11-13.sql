...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2022 a las 00:55:16
...
(2, '../cotizacionimages/../cotizacionimages/1-1.jpeg', 1),
(3, '../cotizacionimages/../cotizacionimages/2-1.jpeg', 1);
...
(2, 'Marvin', 'Urena', '700850888', '50027899', 0),
(6, 'Kendall', 'Ortega', '702880773', '85905028', 1),
...
(1, 'Casa', 'Casa de 200m cuadrados', 3, '2022-10-11', '2022-10-20', '2022-10-29', 1000000, 0, 5, 0, 250000, 0, 31),
(2, 'Corredor', 'Corredor amplio que sirve hasta de cochera', 8, '2022-11-08', '2022-11-02', '2022-10-31', 43323, 3242, 32, 22, 22, 22, 1323);
...
(2, 1, 'pintura', 'se realizan los acabados en pintura', 30),
(3, 2, 'detalles', 'todos los cotra pisos', 60),
(4, 2, 'obra gris', 'pegar blocks', 22);
