...
<body>
    ...
    <section id="form">
        ...
        <table>
            ...
            <form method="post" enctype="multipart/form-data" action="../business/PagoSemanaAction.php">
                <tr>
                    ...
                    echo '<td><input required data-mask="000000" type="hidden" name="semana" id="semana" value="1"   min="1" max = "99999999"/></td>';
