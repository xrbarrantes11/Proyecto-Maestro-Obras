...
<body>
    ...
    <section id="form">
        ...
        <table>
            ...
            <form method="post" enctype="multipart/form-data" action="../business/PagoDiaAction.php">
                <tr>
                    ...
                    echo '<td><input required data-mask="000000" type="text" name="dias" id="dias" value=""   min="1" max = "99999999"/></td>';
                    echo '<td><input required data-mask  ="₡ #.##0,00" type="text" name="monto" id="monto" value="₡ "   min="1" max = "99999999"/></td>';
