...
<body>
    ...
    <section id="form">
        ...
        <table>
            ...
            <form method="post" enctype="multipart/form-data" action="../business/PagoHoraAction.php">
                <tr>
                    ...
                    echo '<td><input required  data-mask="000000" type="text" name="horas" id="horas" value=""   min="1" max = "99999999"/></td>';
                    ?>
            ...
            <td>
                ...
                if (isset($_GET['error'])) {
                    if ($_GET['error'] == "emptyField") {
                        ...
                        echo '<p style="color: red">Error, Empleado no coincide con el tipo seleccionado o no se ha insertado el monto ganado por hora!</p>';
