...
class PdfReporteEmpleadoPago extends FPDF
{
// Cabecera de página
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte Semanal empleado pago',0,0,'C');
    // Salto de línea
    $this->Ln(20);
    $this->Cell(45,10,'Nombre Obra',1,0,'C',0);
    $this->Cell(50,10,'Nombre Empleado',1,0,'C',0);
    $this->Cell(48,10,'Tipo Empleado',1,0,'C',0);
    $this->Cell(48,10,'Monto a Pagar',1,1,'C',0);
}
...
$conn = mysqli_connect("127.0.0.1", "root", "", "bdmaestroobras");
    ...
    $pdf = new PdfReporteEmpleadoPago();
    $pdf->AliasNbPages();
    $pdf->AddPage();
    ...
    while($row=$result->fetch_assoc()){
        ...
        $pdf->Cell(50,10,$row['tbempleadonombre'],1,0,'C',0);
        $pdf->Cell(48,10,$row['tbempleadotiponombre'],1,0,'C',0);
        $pdf->Cell(48,10,$row['tbjornadasemanalsumatoriamontosactividades'],1,1,'C',0);
